...
public class DataBaseProperties {
    ...
    public static final String STUDENTS_TABLE_NAME = "spring_students_student_list";
    public static final String LECTURES_TABLE_NAME = "spring_students_lectures";
    public static final String VISITS_TABLE_NAME = "spring_students_visits";
